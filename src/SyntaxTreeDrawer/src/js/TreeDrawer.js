class TreeDrawer {
    ...
    draw() {
        ...
        var kx_ellipse = function (d) {
            return d.x;
        }
        var ky_ellipse = function (d) {
            return d.y;
        }
        ...
        let preprocessor = new JsonPreprocessor(this.json);
        ...
        var nodes = svg.selectAll(".node")
            .data(nodes)
            .enter();
        var rectNodes = svg.selectAll(".node")
            .data(tree.nodes(root).filter(n => n.container === containers.rectangle))
    .enter();
        var ellipseNodes = svg.selectAll(".node")
            .data(tree.nodes(root).filter(n => n.container === containers.ellipse))
    .enter();
